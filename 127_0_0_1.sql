...
--
-- Vært: 127.0.0.1
-- Genereringstid: 04. 01 2022 kl. 09:48:20
...
-- Database: `limbo`
--
CREATE DATABASE IF NOT EXISTS `limbo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `limbo`;
...
INSERT INTO `users` (`usersId`, `usersRank`, `usersEmail`, `usersUid`, `usersPwd`, `usersStatus`) VALUES
(1, '4', 'Kasperbjoernholdt@hotmail.com', 'Kasper MB', '$2y$10$O1VMaDpT.MMLJd4WqSKoy.VLsnIspg6TFn5HbkiWxH9PZWjWZ6FRG', 'Protected'),
(2, '3', 'userAdmin@hotmail.com', 'Admin', '$2y$10$O1VMaDpT.MMLJd4WqSKoy.VLsnIspg6TFn5HbkiWxH9PZWjWZ6FRG', 'Protected'),
(3, '2', 'Klaus_melsing@hotmail.com', 'Klaus Melsing', '$2y$10$VsvRz56L1qwDKjhXJBGl1OMesd4iO/aauHTq1gvZrf/vYRlDz5XUW', 'None'),
(4, '2', 'mariabjoernholdt@hotmail.com', 'Maria Bjoernholdt', '$2y$10$dAKnQln4/owhRQ8OZTHwqeTEcryB2iLU0mq3IZH8npAbX65/zK1J.', 'None'),
(5, '1', 'TestUser@hotmail.com', 'TestUser', '$2y$10$yVhABbrKp6Rb4JcQZZbsDOJMf68BElz6LQs.NWCDgxrNptRWqdX0G', 'None');
...
('root', '2022-01-04 08:46:20', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"da\",\"NavigationWidth\":191}');
